function FearX.AddBoxZone(name, coords, length, width, options, targetOptions)
    if FearX.Target == 'ox' and FearX.ResourceExists('ox_target') then
    ...
    elseif FearX.Target == 'qb' and FearX.ResourceExists('qb-target') then
    ...
    elseif FearX.Target == 'bt' and FearX.ResourceExists('bt-target') then
